...
app.get("/posts/:id", (req, res) => {
  ...
  let specificPost = posts.find((post) => post.id === id);
...
app.delete("/posts/:id", (req, res) => {
  let id = parseInt(req.params.id);
  let deleteIndex = posts.find((post) => post.id === id);
  if (deleteIndex === undefined) return res.status(404).json({ message: "Post not found" });
